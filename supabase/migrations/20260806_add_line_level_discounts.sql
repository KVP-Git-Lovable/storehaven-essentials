...
-- These columns store the discount percentage for dia and making charges on individual product lines
...
ON order_items(order_id, dia_discount_percent, making_discount_percent);
