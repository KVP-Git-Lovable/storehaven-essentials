...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Online Orders", href: "/transactions/online-orders", moduleKey: "transactions.online_orders" },
    ...
    children: [
      { 
        ...
        subChildren: [
          ...
          { title: "Tax Master", href: "/admin/tax-master", moduleKey: "master.tax-master" },
        ]
      },
      { 
